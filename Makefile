...
EXE := bin/calc_vars_color bin/calc_vars_grad bin/draw_vars bin/resize bin/split_data bin/select_vars
...
lib/draw_vars.o lib/split_data.o lib/select_vars.o: lib/%.o: src/%.cc
	@echo -e "Compiling \E[0;49;94m"$@"\E[0;0m ... "
	@$(CPP) -std=c++11 $(CFLAGS) $(ROOT_CFLAGS) -c $(filter %.cc,$^) -o $@
...
bin/split_data bin/select_vars: bin/%: lib/%.o
	@echo -e "Linking \E[0;49;92m"$@"\E[0;0m ... "
